package com.example.practicekotlin22
...
import com.example.practicekotlin22.data.Repository
import com.example.practicekotlin22.data.models.PhotoResponse
import com.example.practicekotlin22.databinding.ActivityMainBinding
            ...
            .into(
                object : CustomTarget<Bitmap>(SIZE_ORIGINAL, SIZE_ORIGINAL) {
                    ...
                    override fun onLoadStarted(placeholder: Drawable?) {
                        ...
                        Snackbar.make(binding.root, "다운로드 중...", Snackbar.LENGTH_INDEFINITE)
                            .show()
                    }
